...
Korean Map Pack (KMP) is a map mod for Subway Builder with real-world demand maps for 15 Korean cities, built from national transport and population statistics.
...
- **Special demand POIs** — Airport, HSR station, Bus terminal, University, Hospital; each modeled with real ridership, catchment gravity, or enrollment data
- **One map per city** — each city ships a single map at its largest size (40km, except Gyeongju–Pohang's 50km combined map and Jeju's Full Island map)
...
## Further Update Plan
- **v0.4.0: Minor POI Demand** — Adding more POI demand categories to each map, including parks, leisure attractions, and retail centers.
